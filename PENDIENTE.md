...
### B1. Settings — selector de cantón no renderizado [ALTA]
...
### B2. Home — empty state faltante [MEDIA]
...
### B3. Kataloge — store chips definidos pero no renderizados [MEDIA]
...
### B4. Settings — langBtnActive sin estilo visual diferente [MEDIA]
...
### B6. Home — marginTop: 40 en compact mode [BAJA]
...
### B7. Offer Detail — watchProduct usa nombre sin traducir [BAJA]
